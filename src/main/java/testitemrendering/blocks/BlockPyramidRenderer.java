...
public class BlockPyramidRenderer implements ISimpleBlockRenderingHandler {

  static int myRenderID;

  public BlockPyramidRenderer() {
    BlockPyramidRenderer.myRenderID = RenderingRegistry.getNextAvailableRenderId();
  }
